...
class natives {
    ...
    doesWheelHasTire(wheelId_number){}
    getAppearanceDataBase64(){}
    getArmoredWindowHealth(windowId_number){}
    getArmoredWindowShootCount(windowId_number){}
    getBumperDamageLevel(part_number){}
    getDamageStatusBase64(){}
    getDoorState(doorId_number){}
    getExtra(category_number){}
    getGamestateDataBase64(){}
    getHealthDataBase64(){}
    getMod(category_number){}
    getModsCount(category_number){}
    getPartBulletHoles(part_number){}
    getPartDamageLevel(part_number){}
    getScriptDataBase64(){}
    getWheelHealth(wheelId_number){}
    isLightDamaged(lightId_number){}
    isSpecialLightDamaged(specialLightId_number){}
    isWheelBurst(wheelId_number){}
    isWindowDamaged(windowId_number){}
    isWindowOpened(windowId_number){}
    setAppearanceDataBase64(appearanceData_string){}
    setArmoredWindowHealth(p0_number, p1_number){}
    setArmoredWindowShootCount(p0_number, p1_number){}
    setBumperDamageLevel(p0_number, p1_number){}
    setDamageStatusBase64(damageStatus_string){}
    setDoorState(doorID_number, angle0to7or255_number){}
    setExtra(category_number, state_boolean){}
    setGamestateDataBase64(gamestateData_string){}
    setHealthDataBase64(healthData_string){}
    setLightDamaged(p0_number, p1_boolean){}
    setMod(category_number, id_number){}
    setPartBulletHoles(p0_number, p1_number){}
    setPartDamageLevel(p0_number, p1_number){}
    setScriptDataBase64(scriptData_string){}
    setSpecialLightDamaged(p0_number, p1_boolean){}
    setWheelBurst(p0_number, p1_boolean){}
    setWheelHasTire(p0_number, p1_boolean){}
    setWheelHealth(wheelId_number, health_number){}
    setWheels(p0_number, p1_number){}
    setWindowDamaged(p0_number, p1_boolean){}
    setWindowOpened(p0_number, p1_boolean){}
}
...
function getAllData(obj) {
	...
	do {
		const l = Object.getOwnPropertyNames(obj).concat(Object.getOwnPropertySymbols(obj));
